signatories('New Hampshire', 'John Langdon , Nicholas Gilman').
signatories('Massachusetts', 'Nathaniel Gorham , Rufus King').
signatories('Connecticut', 'Wm. Saml. Johnson,Roger Sherman ').
signatories('New York', 'Alexander Hamilton').
signatories('New Jersey', 'Wil: Livingston,David Brearley,Wm. Paterson,Jona: Dayton').
...
signatories('North Carolina', 'Wm. Blount,Richd. Dobbs Spaight,Hu Williamson ').
